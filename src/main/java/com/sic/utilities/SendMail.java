...
public class SendMail extends TestEngine {
	...
	public static void attachReportsToEmail() throws Exception {
		...
		String strBrowser = config.getProperty("browserName");
		String strReportsFolder = "";

		if (strBrowser.toUpperCase().equalsIgnoreCase("IE")) 
		{
			strReportsFolder = "IE";

		} 
		else if (strBrowser.toUpperCase().equalsIgnoreCase("CHROME")) 
		{
