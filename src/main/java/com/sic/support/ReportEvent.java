...
public class ReportEvent extends utility{
	...
	static ExtentReports report = ExtentManager.getInstance();
	 ...
	 static int countOfIntializingTest = 0;
				...
				public static String reportStepPassed(String comment){
					try{
						String path =  utility.passscreeshotCapture();
						String passedComment = "<font color='black' face='Cambria'><b>" + comment +"</b></font>";
						String passedStep = "<a href="+path+">"+passedComment+"</a>";
						return passedStep;
